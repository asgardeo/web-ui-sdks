 ...
 * const pkceKey = extractPKCEKeyFromStateParam(stateParam);
 * // Returns: "pkce_code_verifier_1"
 */
const extractPKCEKeyFromStateParam = (stateParam: string): string => {
...
export default extractPKCEKeyFromStateParam;
